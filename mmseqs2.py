...
def generate_msa(chain_id: str, sequence: str, msa_dir: str) -> str:
    ...
    msa_a3m_path = os.path.join(msa_dir, f"msa_chain_{chain_id}.a3m")
    with open(msa_a3m_path, 'w') as f:
      f.write(unpaired_msa[0])
